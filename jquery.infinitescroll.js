...
(function (window, $, undefined) {
    ...
    $.infinitescroll.prototype = {
        ...
        */
        ...
        _error: function infscr_error(xhr) {
            ...
            opts.state.currPage = 0; // if you need to go back to this instance
    ...
    destroy: function infscr_destroy() {
        ...
        //The following two functions contributed by Dan Goldin via Stack overflow, thread: http://stackoverflow.com/questions/7936270/jquery-infinite-scroll-reset
        // Dan Goldin: http://www.glos.si/dan
        ...
        this._resetmsg();
        this._binding('bind'); // This could be commented out and used as "$(element).infinitescroll('bind')"" in an external script/function
    },
